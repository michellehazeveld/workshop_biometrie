...
:::attention
GEEF HIER JE ONDERZOEKSVRAGEN
1. Is er bij de mens een significant sekseverschil in de lengte van de hand?
2. Is er bij de mens een significant sekseverschil in de breedte van de hand?
3. Is er bij de mens een significant sekseverschil in de lengte/breedte-ratio van de hand?
:::


:::attention
GEEF HIER JE HYPOTHESES
1. Er is bij de mens een significant sekseverschil in de lengte van de hand.
2. Er is bij de mens een significant sekseverschil in de breedte van de hand.
3. Er is bij de mens een significant sekseverschil in de lengte/breedte-ratio van de hand.
:::


:::attention
GEEF HIER JE NULHYPOTHESES
1. Er is bij de mens geen significant sekseverschil in de lengte van de hand.
2. Er is bij de mens geen significant sekseverschil in de breedte van de hand.
3. Er is bij de mens geen significant sekseverschil in de lengte/breedte-ratio van de hand.
:::
...
2. Spreadsheet om resultaten vast te leggen.
...
ggplot(data = biometric_data,
    ...
    theme_minimal()
```
Voor de verschillen aan de hand van twee boxplots is steeds de volgende bron gebruikt: https://content.math4all.nl/sec/content/vc-e6/vc-e63/vc-e63-explanation-1.html 
De boxen overlappen elkaar niet, dus is er een groot verschil in de handlengte tussen mannen en vrouwen.
```{r boxplot-hand-lengte-over-geslacht-ggplot, fig.asp=.75, out.width='80%', fig.align='center'}
ggplot(data = biometric_data,
...
```
De p-waarde is 1.282e-05. Dit is kleiner dan 0.05, dus nulhypothese 1 wordt verworpen. Dit betekent dat er bewijs is gevonden voor een significant verschil in handlengte tussen mannen en vrouwen.
...
```
De p-waarde is 7.335e-05. Dit is kleiner dan 0.05, wat betekent dat nulhypothese 2 wordt verworpen. Dit betekent dat er bewijs is gevonden voor een significant verschil in handbreedte tussen mannen en vrouwen. 
```{r t-test-oplengte-breedte-ratio}
...
```
De p-waarde = 0.4218. Dit is groter dan 0.05, dus nulhypothese 3 wordt niet verworpen. Dit betekent dat er geen bewijs is gevonden voor een significant verschil in handlengte/handbreedte-ratio's tussen mannen en vrouwen.
