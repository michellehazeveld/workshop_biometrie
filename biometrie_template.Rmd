...
# Misschien is deze bron nuttig: https://www.youtube.com/watch?v=4CGLV2dku34
df <- as.data.frame(lengte_breedte_ratio)
write.table(df, "zelf_verzamelde_data_handen.csv",
          append = TRUE, sep = ",")
